...
namespace SYSTEM_MSG_DATA
{
    ...
    inline constexpr char ip[]          = "msg.data.ip";
    inline constexpr char local_port[]  = "msg.data.local_port";
    inline constexpr char remote_port[] = "msg.data.remote_port";
};
...
enum SYSTEM_MSG : unsigned int
{
    ...
    DELETE_GROUP_CHAT    = 4,
    DELETE_MESSAGE       = 5,
    GET_REMOTE_PEER_IP   = 6,
    CLOSE_P2P_CONNECTION = 7,
};
